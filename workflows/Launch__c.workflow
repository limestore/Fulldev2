...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        ...
        <ccEmails>Nancy.Durant@cdk.com</ccEmails>
        <description>Alert Ops - Search and DAP Product Ready for Onboarding</description>
        <protected>false</protected>
        <senderAddress>noreply@cdk.com</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
    ...
    <alerts>
        ...
        <ccEmails>SJanzen@robynpromo.com.fulldev2</ccEmails>
...
(ISPICKVAL(Status__c,&quot;Gathering Requirements&quot;)), 
$RecordType.Name &lt;&gt; &quot;Website Launch&quot;, 
Promotion_Project__r.Name &lt;&gt; &quot;Fight for First&quot; 
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
...
NOT(ISBLANK( Account_Advocate__c))</formula>
    ...
    <rules>
        ...
        <formula>NOT(BEGINS($User.Username,&quot;integration_user@cdk.com&quot;)) &amp;&amp; 
($RecordType.Name = &quot;DAP Launch&quot; ||
 $RecordType.Name = &quot;Search Products Launch&quot;) &amp;&amp;
NOT(ISBLANK(Online_Marketing_Specialist__c))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)) &amp;&amp; 
$RecordType.Name = &quot;SM/RM Launch&quot; &amp;&amp; 
NOT(ISBLANK(Reputation_Management_Specialist__c))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)) &amp;&amp; 
$RecordType.Name = &quot;SM/RM Launch&quot; &amp;&amp; 
NOT(ISBLANK(Social_Media_Specialist__c))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
...
INCLUDES(Product_Type__c,&quot;POWER SEO&quot;), 
INCLUDES(Add_Ons__c,&quot;POWER SEO&quot;)), 
NOT(ISBLANK(PowerSEO_Specialist__c))
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
...
Open_Status__c = &quot;Closed&quot; &amp;&amp;
(INCLUDES( Product_Type__c , &quot;DAP+Email&quot;) || 
INCLUDES( Product_Type__c , &quot;Email Marketing Sales&quot;) || 
INCLUDES( Product_Type__c , &quot;Email Marketing Service&quot;))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
...
(INCLUDES( Product_Type__c , &quot;GM Social Media Essentials&quot;) ||
INCLUDES( Product_Type__c , &quot;Social Media Essentials&quot;) ||
INCLUDES( Product_Type__c , &quot;GM Power Social Media&quot;) ||
INCLUDES( Product_Type__c , &quot;Power Social Media Management&quot;) ||
...
INCLUDES( Product_Type__c , &quot;GM Power Social Media&quot;) ||
INCLUDES( Product_Type__c , &quot;Social Media - Essentials&quot;) ||
INCLUDES( Product_Type__c , &quot;Social Media - Power&quot;)||
INCLUDES( Add_Ons__c  , &quot;RM DAP 5 Star Ads; &quot;) ||
INCLUDES( Add_Ons__c  , &quot;RM DAP 5 Star Video&quot;))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
...
$RecordType.Name &lt;&gt; &quot;A La Carte Launch&quot;&amp;&amp; 
$RecordType.Name &lt;&gt; &quot;AMA Launch&quot;&amp;&amp;
$RecordType.Name &lt;&gt; &quot;OEM Initiated Changes&quot; &amp;&amp;
...
INCLUDES( Product_Type__c , &quot;PowerSEO non-CDK&quot;), 
INCLUDES(Product_Type__c ,&quot;Pre-Roll Video&quot;) 
          )
      )
)
)</formula>
    ...
    <rules>
        <fullName>CB_SvcOps_Search_and_DAP_Launches_Ready_for_ONB</fullName>
        <actions>
            <name>Alert_Ops_Search_Product_Ready_for_Onboarding</name>
            <type>Alert</type>
        </actions>
        ...
        <formula>NOT(Begins($User.Username, $Setup.GlobalSettings__c.Admin_Integration_Username__c))&amp;&amp;
NOT($Profile.Name=&quot;Cobalt Service Data Exporting&quot;) &amp;&amp;
(
$RecordType.Name = &quot;Search Products Launch&quot; &amp;&amp;
(INCLUDES(Product_Type__c, &quot;Holden NV Advertising&quot;)||
INCLUDES(Product_Type__c, &quot;Power Brand NC&quot;)||
INCLUDES(Product_Type__c, &quot;PowerBrand Fixed Ops&quot;)||
INCLUDES(Product_Type__c, &quot;Power Brand&quot;)||
INCLUDES(Product_Type__c, &quot;PowerSearch&quot;)||
INCLUDES(Product_Type__c, &quot;GM CCA Tire Promotion&quot;)||
INCLUDES(Product_Type__c, &quot;ReMarketing&quot;)||
INCLUDES(Product_Type__c, &quot;Special Finance&quot;)||
INCLUDES(Product_Type__c, &quot;Search Essentials&quot;)||
INCLUDES(Product_Type__c, &quot;Display&quot;)||
INCLUDES(Product_Type__c, &quot;Parts&quot;)||
INCLUDES(Product_Type__c, &quot;Service&quot;))&amp;&amp;
(ISPICKVAL(Status__c,&quot;Not Started&quot;) || ISPICKVAL(Status__c,&quot;Gathering Requirements&quot;) ) &amp;&amp; 
Send_Onboarding__c = FALSE
)
||
(
$RecordType.Name = &quot;DAP Launch&quot; &amp;&amp;
(INCLUDES(Product_Type__c, &quot;New Flex&quot;)||
 INCLUDES(Product_Type__c, &quot;Used Flex&quot;)||
 INCLUDES(Product_Type__c, &quot;Service and Parts Flex&quot;))&amp;&amp;
(ISPICKVAL(Status__c,&quot;Not Started&quot;) || ISPICKVAL(Status__c,&quot;Gathering Requirements&quot;) ) &amp;&amp; 
Send_Onboarding__c = FALSE
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
