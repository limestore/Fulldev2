...
Push_Counter__c + 1 
    ...
    <fieldUpdates>
        <fullName>Increment_Push_Counter_Field_old</fullName>
        <description>Increment the Push Counter by 1</description>
        <field>Push_Counter_Field__c</field>
        <formula>IF( 
ISNULL( Push_Counter_Field__c ), 
1, 
Push_Counter_Field__c + 1 
)</formula>
        <name>Increment Push Counter Field Old</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
...
ISPICKVAL(Internal_Lead_Source__c, &quot;Digital Ad Spend Specialist&quot;))</formula>
    ...
    <rules>
        <fullName>Push Counter_old</fullName>
        <actions>
            <name>Increment_Push_Counter_Field_old</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <description>Increment the Push Counter field by 1</description>
 ...
 &amp;&amp; ( $RecordType.Id = &quot;01240000000ICUP&quot; || $RecordType.Id = &quot;01240000000ICUO&quot; || $RecordType.Id = &quot;01240000000ICUN&quot;)</formula>
    ...
    <rules>
        ...
        <active>true</active>
        <description>Set DIgital Marketing QC (Field Update) so it equals: RSF_Digital_Marketing_QC__c + RSF_Digital_Advertising_QC__c</description>
