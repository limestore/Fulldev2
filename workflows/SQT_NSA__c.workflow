...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>DS_BDC_UPD_SharedSytemAddendum</fullName>
        <active>false</active>
        <criteriaItems>
            <field>SQT_NSA__c.NSA_ATTRIBUTES__c</field>
            <operation>equals</operation>
            <value>Shared System Addendum</value>
        </criteriaItems>
        <description>Updated Shared System Addendum checkbox on deal state when Shared System Addendum is there is NSA Attributes</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
</Workflow>
